...
<body>
  <input type="hidden" id="setting" value="<?php echo  URL_SETTING; ?>">
  <input type="hidden" id="app" value="<?php echo  URL_APP; ?>">
  <?php if ($_SESSION) { ?>
    <input type="hidden" id="sesion" value="<?php echo  $_SESSION['id'] ?>">
  <?php } ?>
